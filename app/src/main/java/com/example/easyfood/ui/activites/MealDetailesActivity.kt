...
//        detailsMVVM.getMealById(mealId)
        detailsMVVM.getMealById(mealId.toString())
        ...
        binding.btnSave.setOnClickListener {
            // Animacija rotacije dugmeta
            val rotateAnim = ObjectAnimator.ofFloat(binding.btnSave, "rotation", 0f, 360f)
            rotateAnim.duration = 500  // trajanje animacije u milisekundama
    ...
    private fun deleteMeal() {
        detailsMVVM.deleteMealById(mealId.toString())
    }
    ...
    private fun isMealSavedInDatabase(): Boolean {
        return detailsMVVM.isMealSavedInDatabase(mealId.toString())
    }
...
//        this.mealId = tempIntent.getStringExtra(MEAL_ID)!!
        this.mealId = tempIntent.getStringExtra(MEAL_ID)?.toIntOrNull()!!
        this.mealStr = tempIntent.getStringExtra(MEAL_STR)!!
        this.mealThumb = tempIntent.getStringExtra(MEAL_THUMB)!!
    }

//    @Deprecated("This method overrides a deprecated method")
