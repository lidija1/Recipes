...
//import retrofit2.Response
//
//class CategoryMVVM(private val foodApi: FoodApi) : ViewModel() {
//    private var categories: MutableLiveData<List<Category>> = MutableLiveData<List<Category>>()
//
//    init {
//        getCategories()
...
//
//    private fun getCategories() {
//        foodApi.getCategories().enqueue(object : Callback<CategoryResponse> {
//            override fun onResponse(call: Call<CategoryResponse>, response: Response<CategoryResponse>) {
//                categories.value = response.body()?.categories ?: emptyList()
//            }
//
//            override fun onFailure(call: Call<CategoryResponse>, t: Throwable) {
//                Log.d(TAG, t.message.toString())
